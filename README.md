...
The easiest way to run VibeDialer without installation is using the included `bin/vibedialer` script:
...
bin/vibedialer dial 555-12

# Show welcome screen
bin/vibedialer welcome

# Show keypad ASCII art
bin/vibedialer keypad
